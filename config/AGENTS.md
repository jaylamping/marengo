...
| Task | Location |
|------|----------|
 | Bench default profile | `bringup/arm_2dof_right/` |
...
- Profile selection via `MARENGO_CONFIG_DIR` env var (e.g. `config/bringup/arm_2dof_right`).
