...
if [[ -x "${INSTALL_ROOT}/bin/motor-repl" ]] && [[ -x "${INSTALL_ROOT}/scripts/homing-preflight.sh" ]]; then
  BENCH_CFG="${INSTALL_ROOT}/config/bringup/arm_3dof_right"
...
echo "  4. Example: MARENGO_CONFIG_DIR=config/bringup/arm_3dof_right ${INSTALL_ROOT}/bin/motor-repl status"
