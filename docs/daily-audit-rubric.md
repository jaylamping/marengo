...
- Map changed crates to their paired ADR/decision doc (`ADR_MAP` in `scripts/daily-audit/audit.py` — includes [safety.md](safety.md) for Davout, not only `docs/decisions/`)
