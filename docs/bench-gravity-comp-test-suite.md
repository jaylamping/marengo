...
- Config dir: `config/bringup/shoulder_pitch_right_only/`.
...
```json
{ "tool": "pi_sync_bench_config", "profile": "shoulder_pitch_right_only", "install_to_opt": true }
```
...
1. Edit `config/bringup/shoulder_pitch_right_only/motors.yaml`:
