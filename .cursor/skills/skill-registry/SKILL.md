...
- Do **not** save the registry to mem0 (disabled). Local `.atl/skill-registry.md` is enough.
...
4. Do not persist the registry to mem0 (disabled).
5. Return the registry path, skill count, and whether the cache was regenerated.
