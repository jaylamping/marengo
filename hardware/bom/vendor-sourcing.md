...
| `frame_2020_*` | Cut from `vendor_2020_black_extrusion` | — | 12 named instances in `marengo_torso_frame_asm`; verticals **340 mm**. |
| `sensor_bno085` | Teyleten GY-BNO085 (Amazon / vendor listing) | Adafruit BNO085 breakout | I2C @ **0x4b** on Pi 5 `i2c-1`; see [pi-commissioning.md](../../docs/pi-commissioning.md). |
