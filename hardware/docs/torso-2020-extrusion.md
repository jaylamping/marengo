...
| `frame_2020_bottom_left_100` | `frame_2020_bottom_left_100` | L100 | 1 | **100** |
| `frame_2020_bottom_right_100` | `frame_2020_bottom_right_100` | L100 | 1 | **100** |
| `frame_2020_top_left_100` | `frame_2020_top_left_100` | L100 | 1 | **100** |
| `frame_2020_top_right_100` | `frame_2020_top_right_100` | L100 | 1 | **100** |
...
**Cut stock per cage:** 4×340 + 4×100 + 4×110 = **2200 mm** (one 4×500 mm pack still short; order extra stock).
...
| L340 | Vertical posts |
| L100 | Left/right rails (100 mm depth) |
| L085 | Legacy 85 mm depth rails (superseded by L100 for 100×110 inner) |
