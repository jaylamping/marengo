...
export const robotInventory: InventoryItem[] = [
  ...
  // Right arm — 4-DOF bench (roll+pitch+yaw+elbow); lower-arm yaw not wired yet
  actuator(25, 'right_shoulder_roll', 'right_arm', 'Enabled', '—', '±1.57', 'bench_4dof', 'rs03', 1),
  actuator(26, 'right_shoulder_pitch', 'right_arm', 'Enabled', '—', '−0.9–3.17', 'bench_4dof', 'rs03', 2),
