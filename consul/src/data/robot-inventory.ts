...
export const robotInventory: InventoryItem[] = [
  ...
  // Right arm
  actuator(25, 'right_shoulder_roll', 'right_arm', 'Enabled', '—', '±1.57', 'bench_3dof', 'rs03', 2),
  actuator(26, 'right_shoulder_pitch', 'right_arm', 'Enabled', '—', '−0.9–3.17', 'bench_3dof', 'rs03', 1),
  actuator(27, 'right_upper_arm_yaw', 'right_arm', 'Enabled', '—', '±1.57', 'unassigned', 'rs02', 3),
  actuator(28, 'right_elbow_pitch', 'right_arm', 'Enabled', '—', '0–1.20', 'unassigned', 'rs02', 4),
